...
public class Main_DOE_Templ_Deo {
    public static void main(String argv[]) throws Exception {
        ...
        //***   Output summary file   *********************************************************
        String out_resFileSummary = programPath + File.separator + "OUTPUT" + File.separator + "BAP_DOE_Templ_DEO_CD_tolr.txt";
        ...
        for (int r = 1; r <= 5; r++) {
            ...
            if (solvedSystem.contains("D")) {
                ...
                mySystem.mySimulation.simBAS(true);
                int totcap = 0;
