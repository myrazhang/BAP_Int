...
public class Main_DOE_Templ_StolletzDecomposition {
    public static void main(String argv[]) throws Exception {
        ...
        //***   Output summary file   *********************************************************
        String out_resFileSummary = programPath + File.separator + "OUTPUT" + File.separator + "BAP_DOE_Templ_StolletzDecomp.txt";
        ...
        //for (int thIndex = 0; thIndex <= 2; thIndex++) {
            for (int r = 1; r <= 1; r++) {
                ...
                int totcap;
                {
                    writersum.write("Stolletz+decomposition  ");
                ...
                }*/
                {
                    ...
                    try {
                        myStolletz.solveWithDecomposition(tij);
                        //myReversedAlter6.solveBAPWithIntModel(tij, 0,true);
                    } catch (Exception exc) {
                        exc.printStackTrace();
                    }
                    totalAlter6RevTime.stop();
